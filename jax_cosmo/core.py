...
@register_pytree_node_class
class Cosmology_EDE:
    def __init__(self, Omega_c, Omega_b, h, n_s, sigma8, Omega_k, eme, a_st, w0, flag_ede, gamma=None):
        """
        Cosmology object, stores primary and derived cosmological parameters.
    ...
    def tree_unflatten(cls, aux_data, children):
        # Retrieve base parameters
        Omega_c, Omega_b, h, n_s, sigma8, Omega_k, eme, a_st, w0, flag_ede = children[:10]
        children = list(children[10:]).reverse()
