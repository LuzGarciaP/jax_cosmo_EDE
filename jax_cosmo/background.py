...
def w(cosmo, a):
    ...
    return cosmo.w0 + cosmo.flag_ede*(4./(3.*(1+(a/cosmo.a_st)**(cosmo.eme))))
...
def f_de(cosmo, a):
    ...
    return a**(-4)*cosmo.flag_ede*((1.0+(a/cosmo.a_st)**(cosmo.eme))/(1.0+(1/cosmo.a_st)**(cosmo.eme)))**(4.0/cosmo.eme)
...
def Esqr(cosmo, a):
    ...
    return (
        ...
        + (1 - cosmo.Omega_m) * np.exp(f_de(cosmo, a))
    )
...
def Omega_de_a(cosmo, a):
    ...
    """
    return (1 - cosmo.Omega_m) * np.exp(f_de(cosmo, a)) / Esqr(cosmo, a)
